...
describe("Welcome to ts-pattern", () => {
    describe("Basics", () => {
        it("Let's match some literals", () => {
            ...
            expect(
                renderText({ name: "error", error: { message: "Error" } })
            ).toBe("An error occurred: Error");
        });
        ...
        it("What if the error is unknown? => Wildcards", () => {
            ...
            expect(
                renderText({ name: "error", error: "Error as string" })
            ).toBe("An error occurred: Error as string");
            expect(
                renderText({
                    name: "error",
        ...
        it("Some more basic wildcard patterns", () => {
            ...
            expect(matchPrimitiveType(undefined)).toBe(
